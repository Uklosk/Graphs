...
//CLASE BIPARTICIÓN Y MÉTODO BREADTH FIRST SEARCH
...
public class Bipartite {       
     ...
     public boolean execute(boolean bipartite) throws Exception{                    
             ...
             /* En caso de que existan mas componentes conexas se añadirán
              * dichas componentes por separado para crear la bipartición
              * de cada una
              */
             while(g.getNombres().size() > visited.size()){
                     ...
                     while(v.hasNext() && g.getNombres().size() > visited.size()){
                             ...
                             if(!visited.containsKey(vid)){
                                     ...
                                     /* Recorrido en amplitud de la componente conexa:
             ...
             /* Comprobando que tanto los vértices del subconjunto A
              * pertenecientes a V, como los vértices del subconjunto
              * B pertenecientes a V, son disjuntos en ambos casos
              * con G=(V,A)
              */
             if(bipartite){
      ...
      * Utiliza la hashtable temp sustituyendo en lugar de
      * la estructura de datos conocida como: TAD Cola(java)
      * Partiendo del vértice inicial pasa uno por uno a
      * los adyacentes
      */
